...
/*O*public**/ class EnRouteEvents
{
     ...
     */
    public: static const int32 LISTENER_PICKUPS = 8;
     ...
     *
     */
    public: static const int32 ENROUTE_MANAGER_SHIFT_STARTED = 0x00000200;
    
    /**
     * This event is broadcast when the self agent's shift completes
     *
     */
    public: static const int32 ENROUTE_MANAGER_SHIFT_COMPLETED = 0x00000400;
     ...
     */
    public: static const int32 ENROUTE_MANAGER_SHIFT_START_FAILED = 0x00000800;
     ...
     * param1: error (GString)
     */
    public: static const int32 ENROUTE_MANAGER_SHIFT_COMPLETE_FAILED = 0x00001000;
    
    /**
     * This event is broadcast when the location accuracy authorization is updated
     */
    public: static const int32 ENROUTE_MANAGER_LOCATION_ACCURACY_UPDATED = 0x00002000;
    
    /**
     * This event is broadcast when the predefined messages for an org have been fetched
     */
    public: static const int32 ENROUTE_MANAGER_ORG_PREDEFINED_MESSAGES_UPDATED = 0x00004000;
     ...
     * The associated task is passed as a parameter (GTask)
     */
    public: static const int32 TASKS_TASK_METADATA_UPDATE_SUCCEEDED = 0X00000080;
     ...
     */
    public: static const int32 TASKS_TASK_METADATA_UPDATE_FAILED    = 0X00000100;
     ...
     * The associated task is passed as a parameter (GTask)
     */
    public: static const int32 TASKS_TASK_TRAVEL_MODE_CHANGED = 0x00000800;
    
    public: static const int32 TASKS_TASK_DURATION_CHANGED = 0x00001000;
    
    public: static const int32 TASKS_TASK_DESTINATION_CHANGED = 0x00002000;
    
    public: static const int32 TASKS_TASK_TRANSFERRED = 0x00004000;
     ...
     * The associated task is passed as a parameter (GTask).
    */
    public: static const int32 TASKS_TASK_CHAT_MESSAGES_CHANGED = 0x00008000;
    
    public: static const int32 TASKS_TASK_ROUTE_CHANGED = 0x00010000;
    
    public: static const int32 TASKS_TASK_CREATED = 0x00020000;
    
    public: static const int32 TASKS_TASK_CREATE_FAILED = 0x00040000;
     ...
     * The reason for failusre is passed as a parameter (string).
     */
    public: static const int32 AGENTS_AGENT_UPDATE_FAILED = 0x00000010;
     ...
     * the Pickup Manager
     */
    public: static const int32 PICKUPS_PICKUP_LIST_CHANGED = 0X00000001;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_ACCEPTED = 0X00000002;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_COMPLETED = 0X00000004;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_FAILED_TO_COMPLETE = 0X00000008;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_PHASE_UPDATED = 0x00000010;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_PHASE_UPDATE_FAILED = 0x00000020;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_ASSIGNED = 0x00000040;
     ...
     * param2: GString error
     */
    public: static const int32 PICKUPS_PICKUP_ASSIGN_FAILED = 0x00000080;
     ...
     */
    public: static const int32 PICKUPS_PICKUP_TICKET_AVAILABLE = 0x00000100;
     ...
     * The associated pickup is passed as a parameter (GPickup).
    */
    public: static const int32 PICKUPS_PICKUP_MESSAGES_CHANGED = 0x00000800;
     ...
     * The associated pickup is passed as a parameter (GPickup).
     */
    public: static const int32 PICKUPS_PICKUP_CHANGED = 0x00001000;
     ...
     * The associated pickup is passed as a parameter (GPickup).
    */
    public: static const int32 PICKUPS_PICKUP_CHAT_MESSAGES_CHANGED = 0x00002000;
