 ...
 *
 * Proximity provider never stops monitoring regions automatically after delivering notification.
 * Host application is always responsible for registering and unregistering geofences. 
 *
...
/*O*public**/ struct IProximityProvider : public ICommon
{
     ...
     */
    public: virtual void setProximityListener(const GProximityListener& proximityListener) = 0;
