...
/*O*public**/ class GlympseConstants
{
     ...
     */
    public: static const int32 DELETE_AFTER_COMPLETE_OFF = 0;
    
    /**
     * Tickets will be deleted automatically after they complete
     */
    public: static const int32 DELETE_AFTER_COMPLETE_IMMEDIATE = 1;
    
    /**
     * Tickets will be deleted after a scheduled period of time following complete
     */
    public: static const int32 DELETE_AFTER_COMPLETE_SCHEDULED = 2;
     ...
     */
	public: static GString TICKET_VISIBILITY_LOCATION_CLOAKED()
    {
     ...
     * Verizon Messenger
     */
    public: static GString LINKED_ACCOUNT_TYPE_VERIZON()
    {
   ...
   /**
     ...
     */
    public: static const int32 SERVER_ERROR_PASSWORD_REQUIRED      = 10;
     ...
     */
    public: static GString CONSENT_TYPE_SUBJECT()
    {
     ...
     */
    public: static GString CONSENT_TYPE_GUARDIAN()
    {
     ...
     */
    public: static GString USER_CONSENT_NONE()
    {
     ...
     */
    public: static GString USER_CONSENT_NO()
    {
     ...
     */
    public: static GString USER_CONSENT_YES()
    {
        return CoreFactory::createString("yes");
    }
    
    public: static GString USER_CONSENT_EXEMPT()
    {
     ...
     */
    public: static GString PRIVACY_POLICY_URL()
    {
     ...
     */
    public: static GString TERMS_AND_CONDITIONS_URL()
    {
    ...
    public: static GString CUSTOMER_PICKUP_PHASE_NEW()
    {
        return CoreFactory::createString("new");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_READY()
    {
        return CoreFactory::createString("ready");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_LIVE()
    {
        return CoreFactory::createString("live");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_ARRIVED()
    {
        return CoreFactory::createString("arrived");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_COMPLETED()
    {
        return CoreFactory::createString("completed");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_HOLD()
    {
        return CoreFactory::createString("not_completed");
    }
    public: static GString CUSTOMER_PICKUP_PHASE_CANCELLED()
    {
     ...
     */
    public: static GString TAG_IMAGE_TYPE_LOGO()
    {
        return CoreFactory::createString("logo");
    }
    
    public: static GString TAG_IMAGE_TYPE_AVATAR()
    {
        return CoreFactory::createString("avatar");
    }
    
    public: static GString TAG_IMAGE_TYPE_AD()
    {
