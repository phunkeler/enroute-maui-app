...
struct IString : public ICommon
{
     ...
     * -1 if the specified string is not a substring.
     */
    public: virtual int32 indexOf(const GString& str, int32 start) = 0;
     ...
     */
    public: virtual GString replace(const GString& target, const GString& replacement) = 0;
     ...
     * See equals(const char*) for more details.
     */
    public: virtual bool equals(const GCommon& obj) = 0;
